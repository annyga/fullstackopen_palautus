...
const CreateNew = (props) => {
  ...
  const content = useField('text', false)
  const author = useField('text', false)
  const info = useField('text', false)
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <div>
          content
          <input {...content} reset='test' />
        </div>
        <div>
          author
          <input {...author} reset='test'/>
        </div>
        <div>
          url for more info
          <input {...info} reset='test'/>
        </div>
